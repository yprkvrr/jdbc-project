...
select * from DEVELOPERS
union select * from TESTERS;

select NAMES from DEVELOPERS
union select Names from TESTERS;
 ...
 */
select * from DEVELOPERS
union all select * from TESTERS;

select NAMES from DEVELOPERS
union all select Names from TESTERS;

/*
 minus
 removes instersections

 */

 select Names from Developers
minus select Names from Testers;
select * from Developers
minus select *from Testers;
